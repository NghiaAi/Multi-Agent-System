...
# # =====================================================================
# # Feature engineering from your training code
# # =====================================================================
...
#     X = df_feat[features].iloc[[-1]]  # chỉ dự đoán ngày gần nhất
...
# Given a model decision output (BUY, HOLD, or SELL) and confidence score, explain the reasoning behind the recommendation
# in a short, professional, and data-driven style.
# Reference indicators from the following features if relevant: {feature_list_str}.
...
#     # explainer = create_genai_explainer()
    
#     model_bundle = models[ticker]
#     features = model_bundle["features"]

#     explainer = create_genai_explainer(features)
#     expl_input = json.dumps(decision)
